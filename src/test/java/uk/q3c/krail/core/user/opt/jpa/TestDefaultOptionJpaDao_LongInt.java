 ...
 */
public class TestDefaultOptionJpaDao_LongInt extends DefaultOptionJpaDao_LongInt {
    protected TestDefaultOptionJpaDao_LongInt(EntityManagerProvider entityManagerProvider, StringPersistenceConverter stringPersistenceConverter) {
        super(entityManagerProvider, stringPersistenceConverter);
    }
