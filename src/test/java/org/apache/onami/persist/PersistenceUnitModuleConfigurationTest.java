...
public class PersistenceUnitModuleConfigurationTest {
    ...
    public void shouldHandleUserTransactionProviderType() {
        // given
        final TypeLiteral<? extends Provider<UserTransaction>> utProviderType = TypeLiteral.get(MockUserTransactionProvider.class);
        // when
    ...
    public void shouldHandleEmfProviderType() {
        // given
        final TypeLiteral<? extends Provider<EntityManagerFactory>> emfProviderType = TypeLiteral.get(MockEmfProvider.class);
        // when
    ...
    private static class MockUserTransactionProvider implements Provider<UserTransaction> {
        public UserTransaction get() {
            return mock(UserTransaction.class);
        }
    }

    private static class MockEmfProvider implements Provider<EntityManagerFactory> {
