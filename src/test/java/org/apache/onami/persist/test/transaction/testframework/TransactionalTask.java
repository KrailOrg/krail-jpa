 ...
 * use {@link #storeEntity(org.apache.onami.persist.test.TestEntity)} to common entities in the DB. They also must
...
public abstract class TransactionalTask {
     ...
     * Use {@link #storeEntity(org.apache.onami.persist.test.TestEntity)} to common entities.
     *
     * @throws TestException
     *         may be thrown to test rollback.
