...
public class AllPersistenceUnitsTest {
    ...
    @Test
    public void shouldStartOnAllPersistenceServices() throws Exception {
        // when
    ...
    @Test
    public void shouldStartOnRunningPersistenceServices() throws Exception {
        // given
        doReturn(true).when(ps1)
                      .isRunning();
        doReturn(true).when(ps2)
                      .isRunning();
    ...
    @Test
    public void shouldStartOnAllPersistenceServicesEvenInCaseOfException() throws Exception {
        // given
        doThrow(new RuntimeException()).when(ps1)
                                       .start();
        doThrow(new RuntimeException()).when(ps2)
                                       .start();
    ...
    @Test
    public void shouldStopOnAllPersistenceServices() throws Exception {
        // when
    ...
    @Test
    public void shouldStopOnAllPersistenceServicesEvenInCaseOfException() throws Exception {
        // given
        doThrow(new RuntimeException()).when(ps1)
                                       .stop();
        doThrow(new RuntimeException()).when(ps2)
    ...
    public void shouldNotBeginOnActiveUnitsOfWork() throws Exception {
        // given
        doReturn(true).when(uow1)
                      .isActive();
        doReturn(true).when(uow2)
                      .isActive();
    ...
    @Test
    public void shouldBeginOnAllUnitsOfWorkEvenInCaseOfException() throws Exception {
        // given
        doThrow(new RuntimeException()).when(uow1)
                                       .begin();
        doThrow(new RuntimeException()).when(uow2)
                                       .begin();
    ...
    @Test
    public void shouldEndOnAllUnitsOfWork() throws Exception {
        // when
    ...
    @Test
    public void shouldEndOnAllUnitsOfWorkEvenInCaseOfException() throws Exception {
        // given
        doThrow(new RuntimeException()).when(uow1)
                                       .end();
        doThrow(new RuntimeException()).when(uow2)
