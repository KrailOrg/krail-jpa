...
abstract class OptionDaoTestBase extends Specification {
    ...
    def setup() {
        ...
        cacheKeySpecific10.getRankOption() >> RankOption.SPECIFIC_RANK
        ...
        cacheKeySpecific11.getRankOption() >> RankOption.SPECIFIC_RANK
        ...
        cacheKeySpecific12.getRankOption() >> RankOption.SPECIFIC_RANK
        ...
        cacheKeySpecific2.getRankOption() >> RankOption.SPECIFIC_RANK
    ...
    def "DataList conversion round trip"() {
        ...
        OptionCacheKey<DataList<Integer>> cacheKey = new OptionCacheKey<>(hierarchy1, RankOption.SPECIFIC_RANK, 0, listKey)
    ...
    def "AnnotationList conversion round trip"() {
        ...
        OptionCacheKey<AnnotationList> cacheKey = new OptionCacheKey<>(hierarchy1, RankOption.SPECIFIC_RANK, 0, listKey)
    ...
    def "round trip, single value data types"() {
        given:
        OptionCacheKey cacheKeyString = new OptionCacheKey(hierarchy1, RankOption.SPECIFIC_RANK, optionKeyString)
        OptionCacheKey cacheKeyInteger = new OptionCacheKey(hierarchy1, RankOption.SPECIFIC_RANK, optionKeyInteger)
        OptionCacheKey cacheKeyBoolean = new OptionCacheKey(hierarchy1, RankOption.SPECIFIC_RANK, optionKeyBoolean)
        OptionCacheKey cacheKeyLong = new OptionCacheKey(hierarchy1, RankOption.SPECIFIC_RANK, optionKeyLong)
        OptionCacheKey cacheKeyBigDecimal = new OptionCacheKey(hierarchy1, RankOption.SPECIFIC_RANK, optionKeyBigDecimal)
        OptionCacheKey cacheKeyEnum = new OptionCacheKey(hierarchy1, RankOption.SPECIFIC_RANK, optionKeyEnum)
        OptionCacheKey cacheKeyLocale = new OptionCacheKey(hierarchy1, RankOption.SPECIFIC_RANK, optionKeyLocale)
        when:
    ...
    def "round trip AnnotationOptionList"() {
        ...
        OptionCacheKey cacheKey = new OptionCacheKey(hierarchy1, RankOption.SPECIFIC_RANK, optionKeyAnnotationList)
