...
class TransactionalAnnotationHelper {
     ...
     *         Holder of teh annotation of the persistence unit.
     * @param txnAnnoReader
     *         reader for {@link Transactional @Transactional} annotations.
     */
    @Inject
     ...
     *
     * @param array
     *         the array to test for emptiness.
     *
     ...
     *
     * @param transactional
     *         the transactional annotation of the method during which an exception was thrown.
     * @param exc
     *         the exception which was thrown
     *
     * @return {@code true} if the transaction needs to be rolled back.
     ...
     *
     * @param classes
     *         the classes in which to look fore
     * @param exc
