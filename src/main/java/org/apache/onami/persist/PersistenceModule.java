...
public abstract class PersistenceModule extends AbstractModule {
     ...
     *
     * @param emf
     *         the entity manager factory to use when creating new entity managers.
     *
     * @return the next builder step.
     */
     ...
     *
     * @param jndiName
     *         the JNDI name of the entity manager factory.
     *
     * @return the next builder step.
     */
     ...
     * Binds a container managed persistence unit. The entity manager factory will be retrieved from the given provider.
     *
     * @param emfProviderType
     *         the provider for the entity manager factory.
     *
     * @return the next builder step.
     */
    protected UnannotatedPersistenceUnitBuilder bindContainerManagedPersistenceUnitProvidedBy(TypeLiteral<? extends Provider<EntityManagerFactory>>
                                                                                                      emfProviderType) {
        checkNotNull(configurations, "calling bindContainerManagedPersistenceUnit outside of configurePersistence is not supported");
        final PersistenceUnitModuleConfiguration configurator = createAndAddConfiguration();
