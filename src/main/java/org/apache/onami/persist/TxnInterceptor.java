...
class TxnInterceptor implements MethodInterceptor {
     ...
     *         the method invocation which may be wrapped in a transaction.
     *
     ...
     *
     * @param methodInvocation
     *         the method to be executed within the transaction
     *
     * @return the result of the invocation of the original method.
     *
     * @throws Throwable
     *         if an exception occurs during the call to the original method.
     */
     ...
     *         the original exception. will be thrown in preference to an exception occurring during
     *         execution of this method.
     *
     * @throws Throwable
     *         if an exception happened while ending the unit of work.
     */
     ...
     * @param methodInvocation
     *         the original method invocation.
     * @param transactionFacade
     *         the facade to the underlying resource local or jta transaction.
     *
     * @return the result of the invocation of the original method.
     *
     * @throws Throwable
     ...
     *         the facade to the underlying resource local or jta transaction.
     * @param exc
     *         the exception thrown by the original method.
     */
    @SuppressFBWarnings("LEST_LOST_EXCEPTION_STACK_TRACE")
     ...
     *
     * @param methodInvocation
     *         the method invocation during which an exception was thrown.
     * @param exc
